...
export default function TopNavComponent() {
  return (
    <div className='w-full md:max-w-7xl h-20  p-4 mt-6 border border-borderGreen rounded-xl md:rounded-2xl'>
      ...
      <nav className=' w-full h-full flex justify-between items-center relative'>
        ...
        <div className='tickets'>
          <a href="http://#" className='bg-white py-1 text-borderGreen w-32 md:w-40 h-14 flex justify-center items-center rounded-xl font-semibold'>
